...
gcc -c -I ../include src/main.c src/glad.c src/engine/global.c src/engine/render/render.c src/engine/camera/camera.c src/engine/io/io.c src/engine/input/input.c src/engine/render/render_internal.c
